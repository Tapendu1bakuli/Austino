...
class NewswireDetailsResponseModel {
  Settings? settings;
  int? hasError;
  NewsDetail? newsDetail;

  NewswireDetailsResponseModel({this.settings, this.hasError, this.newsDetail});

  NewswireDetailsResponseModel.fromJson(Map<String, dynamic> json) {
    settings = json['settings'] != null
        ? new Settings.fromJson(json['settings'])
        : null;
    hasError = json['has_error'];
    newsDetail = json['news_detail'] != null
        ? new NewsDetail.fromJson(json['news_detail'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.newsDetail != null) {
      data['news_detail'] = this.newsDetail!.toJson();
    }
    return data;
  }
}
