class MakeShiftSignUpResponseModel {
  Settings? settings;
  int? hasError;

  MakeShiftSignUpResponseModel({this.settings, this.hasError});

  MakeShiftSignUpResponseModel.fromJson(Map<String, dynamic> json) {
